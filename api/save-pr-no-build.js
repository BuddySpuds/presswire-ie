/**
 * Save Press Release WITHOUT triggering Netlify build
 * Uses GitHub API with [skip ci] commit message
 */
...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        // CRITICAL: Use [skip ci] to prevent Netlify build
        ...
        console.log('PR saved without triggering build:', response.data.commit.sha);
        ...
        return {
            ...
            body: JSON.stringify({
                ...
                message: 'Press release saved (no build triggered)',
                skipBuild: true
            })
        };
